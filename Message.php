...
<head>
    ...
    <link rel="stylesheet" href="Shopping/index.css"
...
echo ' <div class="image d-flex justify-content-center">';
    ...
    //      echo "<thead> <tr><th>code</th> <th>name</th> <th>address</th> <th>phone_number</th> <th>Delete</th> <th>Update</th> </tr> </thead> <tbody> \n";
        ...
        while( $rows = mysqli_fetch_array( $results ) ) 
     {
       ...
       echo '<img src="pic1.jpg" class="card-img-top" alt="...">';
       echo '<div class="card-body">';
       echo ' <h5 class="card-title">Texas Husky</h5>';
       echo ' <p class="card-text">It is a 4 year old texas based Husky Breed.  </p>';
         echo '<a href="#" class="btn btn-primary">Adopt</a>';
         echo '</div>';
         echo '</div>';    
        // echo "<tr>";
