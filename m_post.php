...
<h1 style="margin: 20px 430px; color:yellow;"><cite>Matting Post</cite></h1>
<h1 style="margin: 20px 430px; color:yellow;">Welcome <span>  <?php echo "   $username"; ?></span></h1>
...
<form class="ui form" style="max-width:250; margin: 50px 400px" action="create.php" method="get">
  ...
  <div style="color:yellow";class="field">
    ...
    <input type="text" name="category" value="Matting">
  </div>
  <div style="color:yellow";class="field">
