...
<form class="ui form" style="max-width:250; margin: auto;" action='create_result_a.php' method='GET'>
  <div class="field">
  ...
  <button class="ui labled olive button" type="submit">Submit</button> <a href="login_index_a.php" class="ca">Have an account!? Log In</a>
</form>
